...
import { addCommentRepo, createEventRepo, createPostRepo, deleteCommentRepo, deleteEventRepo, deletePostRepo, editCommentRepo, editEventRepo, editPostRepo, giveLikeRepo, joinEventRepo, leaveEventRepo, loadCommentsRepo, loadMyPostsRepo, removeLikeRepo } from "../../src/repositories/post.repository";
...
describe("post.repository tests", () => {
	...
	describe("comments", () => {
		test("addComment saves comment data into DB", async () => {
			...
			const comment = await addCommentRepo(newComment);
