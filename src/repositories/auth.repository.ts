...
export class AuthRepository {
	...
	static registerUser = async (userAuthData: UserCreationEnitity): Promise<UserRegistrationReturnedData> => {
	...
	static loginUserByName = async (username: string): Promise<UserLoginReturnedData> => {
	...
	static loginUserByEmail = async (email: string): Promise<UserLoginReturnedData> => {
