...
export class CommentRepository {
	...
	static addComment = async (commentData: ICommentEntity): Promise<void> => {
	...
	static editComment = async (commentChanges: Omit<ICommentEntity, "created_at" | "post_id" | "user_id">, user_id: string): Promise<void> => {
	...
	static deleteComment = async (ids: Pick<ICommentEntity, "id" | "user_id">): Promise<void> => {
