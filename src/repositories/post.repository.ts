...
export class PostRepository {
	...
	static createPost = async (postCreationData: PostEntity): Promise<void> => {
	...
	static editPost = async (postEdtionData: Omit<PostEntity, "created_at" | "group_id" | "user_id">, user_id: string): Promise<void> => {
	...
	static loadMyPosts = async (user_id: string, offset: number): Promise<PostEntity[]> => {
