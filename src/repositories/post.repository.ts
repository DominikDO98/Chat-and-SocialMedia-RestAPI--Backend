...
export class PostRepository {
	...
	static editPost = async (postEdtionData: Omit<TPost, "created_at" | "group_id" | "user_id">, user_id: string): Promise<void> => {
	...
	static loadMyPosts = async (user_id: string, offset: number): Promise<TPost[]> => {
